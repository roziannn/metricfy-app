        ...
        @foreach ($modules as $item)
            <div class="col d-flex align-items-start">
                <div>
                    ...
                    <p class="mb-0 fs-6 text-center text-body-emphasis mt-3">{{ $item->title }}</p>
                </div>
            </div>
        @endforeach
    </div>
    <div class="row">
        <a href="/materi-belajar" class="text-end text-black-50 font-weight-bold m-0">Materi lainnya <i
