        ...
        <div class="row py-3" style="line-height: 32px;">
            <div class="col-12 text-center">
                <div class="section section-1">
                    ...
                    <div class="col-md-9 text-justify mx-auto pt-4">
                        <p>
                    ...
                    <img src="{{ asset('img/partials/numerasiKehidupan.png') }}" class="col-lg-6 col-sm-12"
                        id="imgNumerasiChar">
                </div>
                <small class="text-muted">Numerasi dan kehidupan</small>

                <div class="section section-2 pt-3">
                    <div class="col-md-9 text-justify mx-auto py-2">
                        ...
                        <p>
                            ...
                            pemahaman dan penerapan konsep matematika secara umum. <b>Numerasi lebih praktis dan terkait
                                ...
                                umum dan
                                teoritis </b>.
                            Lalu, kapan keduanya harus digunakan?
                        </p>
                    </div>
                </div>
                    ...
                    <div class="col-md-9 text-justify mx-auto">
                        ...
                        <div class="d-flex justify-content-center gap-3">
                            <a href="#" class="text-decoration-none" data-bs-toggle="modal"
                                ...
                                <div class="card text-white bg-transparent border-0" style="width: 12rem;">
                                    <div class="card-body rounded-3 bg-primary shadow text-center">
                            ...
                            <a href="#" class="text-decoration-none" data-bs-toggle="modal"
                                ...
                                <div class="card text-white bg-transparent border-0" style="width: 12rem;">
                                    <div class="card-body rounded-3 bg-danger shadow text-center">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div id='carouselInf2' class='carousel slide' data-ride='carousel'>
                                            ...
                                            <a class='carousel-control-prev' href='#carouselInf2' role='button'
                                                data-slide='prev'>
                                                <span class='carousel-control-prev-icon' aria-hidden='true'></span>
                                                <span class='sr-only'>Previous</span>
                                            </a>
                                            <a class='carousel-control-next' href='#carouselInf2' role='button'
                                                data-slide='next'>
                                                <span class='carousel-control-next-icon' aria-hidden='true'></span>
                                                <span class='sr-only'>Next</span>
                                            </a>
            ...
            <div class="section section-5">
                <div class="col-md-9 text-justify mx-auto">
                    ...
                    <h5 class="text-sub-point text-uppercase">Kemampuan Pemecahan Masalah 📈</h5>
                    <ul>
                        <li>
                    ...
                    <h5 class="text-sub-point text-uppercase">Keterampilan Berfikir Kritis 🧠</h5>
                    <ul>
                        <li>
                    ...
                    <h5 class="text-sub-point text-uppercase">Ketelitian dan Keteraturan 🕵️</h5>
                    <ul>
                        <li>
