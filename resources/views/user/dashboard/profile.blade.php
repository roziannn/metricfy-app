                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header border-0">
                                <p class="modal-title fs-6 font-weight-bold" id="staticBackdropLabel">Konfirmasi Logout</p>
                    ...
                    <form action="/profile/update" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-around mt-3 mb-2">
                            <div class="col-sm-6">
                                ...
                                @if ($user->kelas === null)
                                    <div class="my-2">
                                        <span class="text-danger small"><i class="fa-solid fa-triangle-exclamation"></i>
                                            kelas
                                            belum dipilih!</span>
                                    </div>
                                @endif
